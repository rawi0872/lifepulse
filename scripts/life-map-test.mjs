...
assert(nav.includes('href: "/realms"') && nav.includes('icon: icons.lifeMap'), "Navigation exposes Life Map via Realms");
...
assert(coachPage.includes("connect|link|attach") && coachPage.includes("ActionProposalCard"), "NEXTRON UI routes relationship verbs through Prompt 3 proposal UX");
