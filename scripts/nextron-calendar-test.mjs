...
assert(calendar.includes('CALENDAR_MAX_EVENTS = 12') && calendar.includes('CALENDAR_MAX_TOTAL_TEXT') && calendar.includes('CALENDAR_MCP_TIMEOUT_MS') && calendar.includes('maxResults: CALENDAR_MAX_EVENTS'), "N Calendar reads are bounded by calls, count, bytes, and timeout");
