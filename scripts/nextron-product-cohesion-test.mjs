...
assert(coachPage.includes('Task actions are separate from Task read access') && coachPage.includes('explicit approved proposals') && coachPage.includes('Open Tasks'), "Task action permission and post-execution navigation are explicit");
