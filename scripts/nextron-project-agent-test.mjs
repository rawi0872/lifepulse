...
assert(context.includes('row.permission_version !== NEXTRON_PERMISSION_VERSION && row.permission_version !== 5 && row.permission_version !== 4 && row.permission_version !== 3 && row.permission_version !== 2 && row.permission_version !== 1'), "H7 permission migration preserves existing version 1 rows");
