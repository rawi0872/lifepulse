...
const migration27 = read("supabase/migrations/00027_google_drive_selected_files.sql");
...
assert(migration27.includes('permission_version in (1, 2, 3, 4)') && context.includes('row.permission_version !== NEXTRON_PERMISSION_VERSION && row.permission_version !== 4 && row.permission_version !== 3 && row.permission_version !== 2 && row.permission_version !== 1'), "H7 permission migration preserves existing version 1 rows");
