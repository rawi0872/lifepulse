  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-4">
      <div className="text-center">
        ...
        <h2 className="mb-1 text-base font-semibold text-[var(--text)]">Could not load settings</h2>
        <p className="mb-4 text-sm text-[var(--text-muted)]">Something went wrong loading your settings.</p>
        <button
          onClick={reset}
