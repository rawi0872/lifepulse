            ...
            {insights.length > 0 && (
              <div className="mb-6">
                <h3 className="mb-3 break-words text-sm font-medium text-[var(--text-secondary)]">
                  ...
                  <p>These notes are calculated from manually logged wealth data. They summarize logged money context, budget usage, and changes from last month without financial advice.</p>
                  </HelpPopover>
                </h3>
