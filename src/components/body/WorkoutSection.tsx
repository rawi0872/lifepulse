            ...
            {workouts.map((w) => (
              <div key={w.id}>
                <button
                  ...
                  className="flex w-full items-center justify-between px-4 py-3 text-left transition-colors hover:bg-[var(--surface-soft)]"
                >
                    ...
                    {(exercises[w.id] ?? []).length > 0 && (
                      <div className="divide-y divide-[var(--border-soft)]">
                        {(exercises[w.id] ?? []).map((e) => (
                          <div key={e.id} className="flex items-center justify-between px-6 py-2">
                            <span className="text-xs text-[var(--text)]">{e.exercise_name}</span>
                            <span className="text-[10px] text-[var(--text-muted)]">
                    ...
                    <div className="border-t border-[var(--border)] p-4">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <input
                          ...
                          className="col-span-3 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-xs text-[var(--text)] placeholder:text-[var(--text-muted)] outline-none"
                        />
                        <input
                        ...
                        <button
                          ...
                          className="col-span-3 rounded-lg bg-[var(--accent)] px-3 py-2 text-xs font-medium text-[var(--text-on-accent)] transition-all hover:opacity-90 disabled:opacity-40"
                        >
