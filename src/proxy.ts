...
const protectedRoutes = ["/onboarding", "/today", "/habits", "/tasks", "/projects", "/results", "/journal", "/insights", "/settings", "/account", "/finance", "/wealth", "/realms", "/body", "/mind", "/goals", "/devices", "/weekly-review", "/knowledge", "/passions", "/coach", "/nextron"];
