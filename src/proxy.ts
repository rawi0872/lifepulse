...
const protectedRoutes = ["/onboarding", "/today", "/habits", "/tasks", "/projects", "/results", "/journal", "/insights", "/settings", "/account", "/finance", "/wealth", "/realms", "/body", "/mind", "/goals", "/devices", "/weekly-review", "/knowledge", "/passions", "/coach", "/nextron", "/life-map"];
...
export async function proxy(request: NextRequest) {
  ...
  if (pathname === "/") {
    return NextResponse.redirect(
      new URL(onboardingDone ? "/today" : "/onboarding", request.url),
    );
  }
